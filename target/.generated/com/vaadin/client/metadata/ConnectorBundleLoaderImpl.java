...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Image","com.vaadin.ui.NativeSelect","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.Video","com.vaadin.ui.Panel","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Table","com.vaadin.ui.CheckBox","com.vaadin.ui.NativeButton","com.vaadin.ui.TwinColSelect","com.vaadin.ui.ProgressBar","com.vaadin.ui.CustomField","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.OptionGroup","com.vaadin.ui.CustomLayout","com.vaadin.ui.Label","com.vaadin.ui.Upload","com.vaadin.ui.Audio","com.vaadin.ui.JavaScript","com.vaadin.ui.Link","com.vaadin.ui.CustomComponent","com.vaadin.ui.InlineDateField","com.vaadin.ui.Flash","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Accordion","com.vaadin.ui.MenuBar","com.vaadin.server.FileDownloader","com.vaadin.ui.Embedded","com.vaadin.ui.PasswordField","com.vaadin.ui.TabSheet","com.vaadin.ui.Tree","com.vaadin.ui.GridLayout","com.vaadin.ui.Slider","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.ListSelect","com.vaadin.ui.Window","com.vaadin.ui.DateField","com.vaadin.ui.TextField","com.vaadin.ui.CssLayout","com.vaadin.ui.PopupView","com.vaadin.ui.Button","com.vaadin.ui.FormLayout","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.Form","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.TextArea","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.VerticalLayout","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.UI","com.vaadin.ui.ComboBox","com.vaadin.ui.TreeTable",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"styles", "registeredEventListeners", "modified", "height", "width", "enabled", "hideErrors", "readOnly", "required", "immediate", "primaryStyleName", "resources", "errorMessage", "propertyReadOnly", "tabIndex", "caption", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"row2", "column1", "column2", "row1", "alignment", });
            ...
            store.setProperties(java.util.Date.class, new String[] {"month", "year", "date", "time", "hours", "seconds", "minutes", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"caption", "description", "height", "width", "registeredEventListeners", "alternateText", "id", "enabled", "readOnly", "immediate", "resources", "styles", "errorMessage", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"height", "primaryStyleName", "width", "immediate", "tabIndex", "styles", "description", "registeredEventListeners", "enabled", "resources", "readOnly", "id", "caption", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"enabled", "resources", "errorMessage", "width", "registeredEventListeners", "height", "readOnly", "id", "caption", "primaryStyleName", "description", "spacing", "marginsBitmask", "styles", "childData", "immediate", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"styles", "id", "enabled", "resources", "description", "width", "height", "immediate", "readOnly", "caption", "registeredEventListeners", "errorMessage", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"immediate", "rangeEnd", "required", "primaryStyleName", "styles", "id", "modified", "tabIndex", "enabled", "height", "errorMessage", "hideErrors", "description", "resources", "propertyReadOnly", "width", "registeredEventListeners", "rangeStart", "readOnly", "caption", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"styles", "errorMessage", "childLocations", "primaryStyleName", "resources", "width", "id", "templateName", "height", "readOnly", "immediate", "caption", "description", "registeredEventListeners", "templateContents", "enabled", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"errorMessage", "readOnly", "width", "spacing", "styles", "resources", "immediate", "childData", "marginsBitmask", "id", "caption", "registeredEventListeners", "description", "enabled", "primaryStyleName", "height", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"primaryStyleName", "tabIndex", "height", "immediate", "enabled", "modified", "resources", "styles", "readOnly", "required", "registeredEventListeners", "hideErrors", "id", "errorMessage", "propertyReadOnly", "description", "caption", "width", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"resizable", "resources", "registeredEventListeners", "centered", "caption", "positionX", "positionY", "scrollLeft", "height", "tabIndex", "errorMessage", "draggable", "description", "immediate", "scrollTop", "readOnly", "styles", "enabled", "resizeLazy", "windowMode", "id", "primaryStyleName", "width", "modal", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"description", "tabIndex", "resources", "registeredEventListeners", "height", "hideErrors", "width", "modified", "styles", "required", "enabled", "readOnly", "caption", "primaryStyleName", "propertyReadOnly", "id", "errorMessage", "immediate", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"registeredEventListeners", "readOnly", "height", "primaryStyleName", "id", "width", "resources", "immediate", "description", "caption", "styles", "enabled", "childCss", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"registeredEventListeners", "width", "errorMessage", "primaryStyleName", "resources", "readOnly", "id", "enabled", "description", "rpcInterfaces", "caption", "styles", "height", "callbackNames", "immediate", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LoadingIndicatorConfigurationState.class, new String[] {"thirdDelay", "firstDelay", "secondDelay", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"resources", "width", "enabled", "height", "errorMessage", "id", "immediate", "htmlContentAllowed", "primaryStyleName", "tabIndex", "iconAltText", "readOnly", "disableOnClick", "clickShortcutKeyCode", "description", "registeredEventListeners", "caption", "styles", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"caption", "primaryStyleName", "immediate", "styles", "resources", "height", "errorMessage", "connectorToCssPosition", "width", "readOnly", "registeredEventListeners", "enabled", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"id", "description", "readOnly", "caption", "styles", "propertyReadOnly", "primaryStyleName", "registeredEventListeners", "required", "enabled", "hideErrors", "height", "modified", "resources", "tabIndex", "width", "immediate", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionUnit", "minPositionUnit", "maxPositionUnit", "position", "locked", "positionReversed", "maxPosition", "minPosition", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"quickOpenDelay", "maxWidth", "closeTimeout", "quickOpenTimeout", "openDelay", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"height", "registeredEventListeners", "id", "pollInterval", "localeServiceState", "resources", "tooltipConfiguration", "immediate", "primaryStyleName", "tabIndex", "width", "styles", "description", "enabled", "overlayContainerLabel", "readOnly", "errorMessage", "pushConfiguration", "caption", "pageState", "loadingIndicatorConfiguration", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"immediate", "enabled", "styles", "primaryStyleName", "readOnly", "registeredEventListeners", "width", "errorMessage", "caption", "alternateText", "id", "description", "height", "resources", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"errorMessage", "id", "hideErrors", "propertyReadOnly", "primaryStyleName", "caption", "styles", "width", "readOnly", "registeredEventListeners", "description", "immediate", "modified", "layout", "footer", "tabIndex", "enabled", "required", "resources", "height", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"propertyReadOnly", "width", "required", "id", "caption", "readOnly", "registeredEventListeners", "resources", "modified", "immediate", "tabIndex", "styles", "primaryStyleName", "errorMessage", "hideErrors", "enabled", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"primaryStyleName", "id", "enabled", "height", "width", "errorMessage", "spacing", "readOnly", "columns", "styles", "marginsBitmask", "immediate", "rows", "caption", "registeredEventListeners", "childData", "description", "resources", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"styles", "errorMessage", "immediate", "registeredEventListeners", "enabled", "value", "hideErrors", "resolution", "maxValue", "minValue", "width", "caption", "primaryStyleName", "propertyReadOnly", "resources", "orientation", "tabIndex", "readOnly", "required", "modified", "height", "description", "id", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"errorMessage", "resources", "height", "description", "readOnly", "enabled", "registeredEventListeners", "styles", "text", "width", "immediate", "primaryStyleName", "contentMode", "caption", "id", });
            ...
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"height", "description", "styles", "immediate", "secondChild", "registeredEventListeners", "width", "firstChild", "splitterState", "readOnly", "resources", "id", "errorMessage", "caption", "primaryStyleName", "enabled", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"height", "readOnly", "styles", "resources", "enabled", "registeredEventListeners", "primaryStyleName", "errorMessage", "width", "immediate", "id", "caption", "description", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"styles", "width", "errorMessage", "enabled", "codebase", "classId", "standby", "codetype", "caption", "alternateText", "height", "registeredEventListeners", "id", "readOnly", "resources", "embedParams", "description", "primaryStyleName", "immediate", "archive", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"immediate", "hideErrors", "height", "tabIndex", "required", "primaryStyleName", "styles", "columns", "width", "maxLength", "caption", "registeredEventListeners", "readOnly", "enabled", "resources", "propertyReadOnly", "errorMessage", "description", "inputPrompt", "id", "text", "modified", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"rpcInterfaces", "resources", "callbackNames", "registeredEventListeners", "enabled", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"clientX", "metaKey", "clientY", "button", "ctrlKey", "altKey", "relativeX", "relativeY", "shiftKey", "type", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"enabled", "immediate", "caption", "showControls", "styles", "width", "errorMessage", "registeredEventListeners", "altText", "muted", "sourceTypes", "readOnly", "sources", "primaryStyleName", "id", "resources", "htmlContentAllowed", "autoplay", "description", "height", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"errorMessage", "primaryStyleName", "id", "height", "styles", "readOnly", "enabled", "resources", "registeredEventListeners", "description", "immediate", "caption", "width", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"id", "tabIndex", "immediate", "scrollLeft", "enabled", "scrollTop", "caption", "readOnly", "resources", "width", "errorMessage", "primaryStyleName", "description", "height", "styles", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"registeredEventListeners", "resources", "clickShortcutKeyCode", "iconAltText", "caption", "height", "enabled", "readOnly", "immediate", "primaryStyleName", "description", "disableOnClick", "width", "errorMessage", "styles", "id", "htmlContentAllowed", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"readOnly", "height", "errorMessage", "width", "caption", "description", "resources", "styles", "id", "primaryStyleName", "immediate", "hideOnMouseOut", "enabled", "html", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"shortDayNames", "shortMonthNames", "pm", "firstDayOfWeek", "name", "dayNames", "twelveHourClock", "monthNames", "am", "dateFormat", "hourMinuteDelimiter", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"immediate", "primaryStyleName", "errorMessage", "parameters", "styles", "uriFragment", "resources", "id", "caption", "height", "features", "enabled", "width", "registeredEventListeners", "target", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"required", "hideErrors", "enabled", "propertyReadOnly", "indeterminate", "registeredEventListeners", "resources", "description", "id", "primaryStyleName", "readOnly", "styles", "width", "errorMessage", "modified", "state", "immediate", "caption", "height", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"tabIndex", "immediate", "styles", "enabled", "modified", "height", "width", "required", "readOnly", "primaryStyleName", "description", "registeredEventListeners", "id", "hideErrors", "propertyReadOnly", "errorMessage", "caption", "resources", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"styles", "primaryStyleName", "resources", "description", "width", "enabled", "registeredEventListeners", "immediate", "firstChild", "caption", "errorMessage", "secondChild", "height", "splitterState", "readOnly", "id", });
            store.setProperties(com.vaadin.shared.ui.ui.PageState.class, new String[] {"hasResizeListeners", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"tabIndex", "width", "errorMessage", "readOnly", "registeredEventListeners", "enabled", "id", "propertyReadOnly", "primaryStyleName", "resources", "immediate", "required", "description", "height", "hideErrors", "modified", "caption", "styles", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"width", "description", "errorMessage", "resources", "id", "registeredEventListeners", "alternateText", "readOnly", "height", "immediate", "enabled", "styles", "caption", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"id", "hideErrors", "immediate", "errorMessage", "styles", "propertyReadOnly", "height", "readOnly", "description", "caption", "resources", "primaryStyleName", "width", "enabled", "tabIndex", "registeredEventListeners", "modified", "checked", "required", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"height", "rangeEnd", "required", "description", "registeredEventListeners", "enabled", "id", "readOnly", "textFieldEnabled", "immediate", "tabIndex", "caption", "hideErrors", "descriptionForAssistiveDevices", "rangeStart", "errorMessage", "resources", "propertyReadOnly", "primaryStyleName", "width", "styles", "modified", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"readOnly", "state", "id", "pollingInterval", "enabled", "caption", "indeterminate", "primaryStyleName", "propertyReadOnly", "width", "required", "registeredEventListeners", "tabIndex", "hideErrors", "description", "styles", "modified", "errorMessage", "resources", "immediate", "height", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"resources", "immediate", "enabled", "readOnly", "spacing", "styles", "width", "registeredEventListeners", "childData", "height", "primaryStyleName", "description", "id", "caption", "errorMessage", "marginsBitmask", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"resources", "muted", "showControls", "id", "errorMessage", "caption", "readOnly", "styles", "autoplay", "height", "registeredEventListeners", "enabled", "width", "altText", "htmlContentAllowed", "sources", "immediate", "description", "primaryStyleName", "sourceTypes", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"mode", "parameters", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"styles", "caption", "modified", "resources", "id", "height", "primaryStyleName", "rows", "readOnly", "errorMessage", "inputPrompt", "columns", "registeredEventListeners", "maxLength", "enabled", "text", "tabIndex", "propertyReadOnly", "required", "immediate", "width", "hideErrors", "description", "wordwrap", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"actionKey", "endDate", "iconKey", "startDate", "caption", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"events", "primaryStyleName", "firstDayOfWeek", "height", "id", "immediate", "lastVisibleDayOfWeek", "now", "errorMessage", "actions", "enabled", "width", "styles", "caption", "resources", "monthNames", "scroll", "dayNames", "format24H", "registeredEventListeners", "description", "firstVisibleDayOfWeek", "readOnly", "lastHourOfDay", "days", "firstHourOfDay", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"styleName", "caption", "dateFrom", "index", "timeTo", "description", "timeFrom", "allDay", "dateTo", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"registeredEventListeners", "caption", "height", "styles", "primaryStyleName", "immediate", "readOnly", "id", "cursorX", "description", "resources", "cursorY", "bgColor", "width", "enabled", "errorMessage", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"width", "registeredEventListeners", "enabled", "styles", "description", "readOnly", "color", "popupVisible", "immediate", "height", "resources", "errorMessage", "htmlContentAllowed", "primaryStyleName", "caption", "showDefaultCaption", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"styles", "changedX", "changedY", "readOnly", "description", "enabled", "changedColor", "rowCount", "resources", "errorMessage", "primaryStyleName", "height", "columnCount", "id", "width", "registeredEventListeners", "immediate", "caption", });
